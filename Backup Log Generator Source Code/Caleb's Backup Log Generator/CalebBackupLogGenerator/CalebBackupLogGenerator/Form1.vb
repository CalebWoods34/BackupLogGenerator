...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click 'This is the command for the button that will allow the user to input their password
        ...
        VinhPin = 1314
        MikePin = 3311
        template1 = "S:AutoCure 2.0\Caleb's Backup Log Generator\Oven Template\FDI Log Template - Oven.xlsx"
        template2 = "S:\AutoCure 2.0\Caleb's Backup Log Generator\Press Template\FDI Log Template - Press.xlsx"
        template3 = "S:\AutoCure 2.0\Caleb's Backup Log Generator\IVEC Pump Template\FDI Log Template - IVEC Pump.xlsx"
        template4 = "S:\AutoCure 2.0\Caleb's Backup Log Generator\Mahr Pump Template\FDI Log Template - Mahr Pump.xlsx"
        OpenFileDialog2.InitialDirectory = "S:\AutoCure 2.0\Caleb's Backup Log Generator"
        ...
        OpenFileDialog1.InitialDirectory = "S:\KEVIN\logs" 'This directs the openfiledialog box to search this directory
